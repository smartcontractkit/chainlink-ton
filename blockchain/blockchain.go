...
type Input struct {
	...
	// Ton - MyLocalTon essential services to run tests
...
// todo: this is temporary, discussion in progress, having blockchain in ctf vs chain specific implementation
// todo: currently only copied from ctf, need to restructure it
