...
import (
	...
	deploymentutils "github.com/smartcontractkit/chainlink-ton/deployment/utils"
...
func TestAddLanes(t *testing.T) {
	...
	require.NoError(t, err)
	cs := commonchangeset.Configure(tonops.DeployCCIPContracts{}, tonops.DeployChainContractsConfig(t, env, tonChainSelector, deploymentutils.ContractsVersionLocal, contractID))
