...
func TestDecodeOffRampData(t *testing.T) {
	...
	t.Run("TestModel", func(t *testing.T) {
		...
		// RMN Router
		require.Equal(t, rmnRouter, storage.Config.StaticConfig.RMNRouter)
		require.Equal(t, tokenAdminRegistry, storage.Config.StaticConfig.TokenAdminRegistry)
		...
		// Chain selector
		require.Equal(t, tonChainSelector, storage.Config.StaticConfig.ChainSelector)
	...
	t.Run("TestMapper", func(t *testing.T) {
		...
		hexData := ""
