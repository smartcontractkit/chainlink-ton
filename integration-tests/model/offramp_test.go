...
func TestDecodeOffRampData(t *testing.T) {
	...
	t.Run("TestModel", func(t *testing.T) {
		...
		// RMN Router
		require.Equal(t, rmnRouter, storage.StaticConfig.RMNRouter)
		require.Equal(t, tokenAdminRegistry, storage.StaticConfig.TokenAdminRegistry)
		...
		// Chain selector
		require.Equal(t, tonChainSelector, storage.StaticConfig.ChainSelector)
	...
	t.Run("TestMapper", func(t *testing.T) {
		...
		hexData := ""
