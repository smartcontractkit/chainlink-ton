...
export class UpgradeableWithLockV2 implements Contract, TypeAndVersion, Upgradeable {
  ...
  static createFromAddress(address: Address) {
    return new UpgradeableWithLockV2(address)
  }

  static code(): Promise<Cell> {
    return compile('examples.upgrades.UpgradeableWithLockV2')
  }
  ...
  static createFromConfig(config: WithLockConfig, code: Cell, workchain = 0) {
    ...
    return new UpgradeableWithLockV2(contractAddress(workchain, init), init)
  }
