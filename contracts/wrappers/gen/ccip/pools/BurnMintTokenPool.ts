...
export type BurnMintTokenPool_PendingMint_Shallow = Omit<BurnMintTokenPool_PendingMint, 'request' | 'out'> & {
    request: c.Cell
    out: c.Cell
}
...
export const BurnMintTokenPool_PendingMint = {
    ...
    createShallow(args: {
        ...
        out: c.Cell
        expectedSender: c.Address
        }): BurnMintTokenPool_PendingMint_Shallow {
        return {
                    $: 'BurnMintTokenPool_PendingMint',
                    ...args
                }
    ...
    fromSliceShallow(s: c.Slice): BurnMintTokenPool_PendingMint_Shallow {
        return {
                    $: 'BurnMintTokenPool_PendingMint',
                    replyTo: s.loadMaybeAddress(),
                    request: s.loadRef(),
    ...
    storeShallow(self: BurnMintTokenPool_PendingMint_Shallow, b: c.Builder): void {
        b.storeAddress(self.replyTo);
        b.storeRef(self.request);
        b.storeRef(self.out);
        b.storeAddress(self.expectedSender);
    ...
    toCellShallow(self: BurnMintTokenPool_PendingMint_Shallow): c.Cell {
        return makeCellFrom<BurnMintTokenPool_PendingMint_Shallow>(self, BurnMintTokenPool_PendingMint.storeShallow);
    }
}
...
export interface Storage {
    ...
    pendingBurns: Map<uint64, BurnMintTokenPool_PendingBurn> /* = [] as map<uint64, Cell<BurnMintTokenPool_PendingBurn>> */
    pendingMints: Map<uint64, BurnMintTokenPool_PendingMint> /* = [] as map<uint64, Cell<BurnMintTokenPool_PendingMint>> */
}
...
export class BurnMintTokenPool implements c.Contract {
    static CodeCell = c.Cell.fromBase64('');
