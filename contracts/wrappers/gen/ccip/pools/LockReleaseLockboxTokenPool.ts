...
export const TokenPool_PreflightCheck = {
    ...
    storeShallow(self: TokenPool_PreflightCheck_Shallow, b: c.Builder): void {
        b.storeUint(0x4129d109, 32);
        b.storeUint(self.queryId, 64);
        b.storeRef(self.request);
        b.storeUint(self.requestedFinalityConfig, 32);
    ...
    toCellShallow(self: TokenPool_PreflightCheck_Shallow): c.Cell {
        return makeCellFrom<TokenPool_PreflightCheck_Shallow>(self, TokenPool_PreflightCheck.storeShallow);
    }
}
...
export const TokenPool_PostflightCheck = {
    ...
    storeShallow(self: TokenPool_PostflightCheck_Shallow, b: c.Builder): void {
        b.storeUint(0x703c2b58, 32);
        b.storeUint(self.queryId, 64);
        b.storeRef(self.request);
        b.storeCoins(self.localAmount);
    ...
    toCellShallow(self: TokenPool_PostflightCheck_Shallow): c.Cell {
        return makeCellFrom<TokenPool_PostflightCheck_Shallow>(self, TokenPool_PostflightCheck.storeShallow);
    }
}
...
export const TokenPool_LockedOrBurned = {
    ...
    storeShallow(self: TokenPool_LockedOrBurned_Shallow, b: c.Builder): void {
        b.storeUint(self.remoteChainSelector, 64);
        b.storeRef(self.details);
    },
    ...
    toCellShallow(self: TokenPool_LockedOrBurned_Shallow): c.Cell {
        return makeCellFrom<TokenPool_LockedOrBurned_Shallow>(self, TokenPool_LockedOrBurned.storeShallow);
    }
}
...
export const TokenPool_ReleasedOrMinted = {
    ...
    storeShallow(self: TokenPool_ReleasedOrMinted_Shallow, b: c.Builder): void {
        b.storeUint(self.remoteChainSelector, 64);
        b.storeRef(self.details);
    },
    ...
    toCellShallow(self: TokenPool_ReleasedOrMinted_Shallow): c.Cell {
        return makeCellFrom<TokenPool_ReleasedOrMinted_Shallow>(self, TokenPool_ReleasedOrMinted.storeShallow);
    }
}
...
export const TokenPool_ReleasedOrMintedDetails = {
    ...
    storeShallow(self: TokenPool_ReleasedOrMintedDetails_Shallow, b: c.Builder): void {
        b.storeAddress(self.token);
        b.storeAddress(self.sender);
        b.storeCoins(self.amount);
        b.storeRef(self.recipient);
    },
    ...
    toCellShallow(self: TokenPool_ReleasedOrMintedDetails_Shallow): c.Cell {
        return makeCellFrom<TokenPool_ReleasedOrMintedDetails_Shallow>(self, TokenPool_ReleasedOrMintedDetails.storeShallow);
    }
}
...
export const TokenPool_RemotePoolAdded = {
    ...
    storeShallow(self: TokenPool_RemotePoolAdded_Shallow, b: c.Builder): void {
        b.storeUint(self.remoteChainSelector, 64);
        b.storeRef(self.remotePoolAddress);
    },
    ...
    toCellShallow(self: TokenPool_RemotePoolAdded_Shallow): c.Cell {
        return makeCellFrom<TokenPool_RemotePoolAdded_Shallow>(self, TokenPool_RemotePoolAdded.storeShallow);
    }
}
...
export const TokenPool_RemotePoolRemoved = {
    ...
    storeShallow(self: TokenPool_RemotePoolRemoved_Shallow, b: c.Builder): void {
        b.storeUint(self.remoteChainSelector, 64);
        b.storeRef(self.remotePoolAddress);
    },
    ...
    toCellShallow(self: TokenPool_RemotePoolRemoved_Shallow): c.Cell {
        return makeCellFrom<TokenPool_RemotePoolRemoved_Shallow>(self, TokenPool_RemotePoolRemoved.storeShallow);
    }
}
...
export type LockReleaseLockboxTokenPool_PendingLock_Shallow = Omit<LockReleaseLockboxTokenPool_PendingLock, 'forwardPayload'> & {
    forwardPayload: c.Cell
}
...
export const LockReleaseLockboxTokenPool_PendingLock = {
    ...
    fromSliceShallow(s: c.Slice): LockReleaseLockboxTokenPool_PendingLock_Shallow {
        return {
                    $: 'LockReleaseLockboxTokenPool_PendingLock',
                    queryId: s.loadUintBig(64),
                    forwardPayload: s.loadRef()
    ...
    storeShallow(self: LockReleaseLockboxTokenPool_PendingLock_Shallow, b: c.Builder): void {
        b.storeUint(self.queryId, 64);
        b.storeRef(self.forwardPayload);
    },
    ...
    toCellShallow(self: LockReleaseLockboxTokenPool_PendingLock_Shallow): c.Cell {
        return makeCellFrom<LockReleaseLockboxTokenPool_PendingLock_Shallow>(self, LockReleaseLockboxTokenPool_PendingLock.storeShallow);
    }
}
...
export type LockReleaseLockboxTokenPool_PendingRelease_Shallow = Omit<LockReleaseLockboxTokenPool_PendingRelease, 'replyTo' | 'request' | 'out'> & {
    replyTo: c.Cell
    request: c.Cell
    out: c.Cell
}
...
export const LockReleaseLockboxTokenPool_PendingRelease = {
    ...
    fromSliceShallow(s: c.Slice): LockReleaseLockboxTokenPool_PendingRelease_Shallow {
        return {
                    $: 'LockReleaseLockboxTokenPool_PendingRelease',
                    queryId: s.loadUintBig(64),
                    replyTo: s.loadRef(),
    ...
    storeShallow(self: LockReleaseLockboxTokenPool_PendingRelease_Shallow, b: c.Builder): void {
        b.storeUint(self.queryId, 64);
        b.storeRef(self.replyTo);
        b.storeRef(self.request);
        b.storeRef(self.out);
    },
    ...
    toCellShallow(self: LockReleaseLockboxTokenPool_PendingRelease_Shallow): c.Cell {
        return makeCellFrom<LockReleaseLockboxTokenPool_PendingRelease_Shallow>(self, LockReleaseLockboxTokenPool_PendingRelease.storeShallow);
    }
}
...
export const Storage = {
    ...
    fromSlice(s: c.Slice): Storage {
        return {
            ...
            pendingLocks: dictToMap(c.Dictionary.load<uint64, LockReleaseLockboxTokenPool_PendingLock>(c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingLock>(
            ...
            pendingReleases: dictToMap(c.Dictionary.load<uint64, LockReleaseLockboxTokenPool_PendingRelease>(c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingRelease>(
    ...
    store(self: Storage, b: c.Builder): void {
        ...
        b.storeDict<uint64, LockReleaseLockboxTokenPool_PendingLock>(mapToDict(self.pendingLocks, c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingLock>(
                        (s) => loadCellRef<LockReleaseLockboxTokenPool_PendingLock>(s, LockReleaseLockboxTokenPool_PendingLock.fromSlice),
                        (v,b) => storeCellRef<LockReleaseLockboxTokenPool_PendingLock>(v, b, LockReleaseLockboxTokenPool_PendingLock.store)
                    )), c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingLock>(
            (s) => loadCellRef<LockReleaseLockboxTokenPool_PendingLock>(s, LockReleaseLockboxTokenPool_PendingLock.fromSlice),
            (v,b) => storeCellRef<LockReleaseLockboxTokenPool_PendingLock>(v, b, LockReleaseLockboxTokenPool_PendingLock.store)
        ));
        b.storeDict<uint64, LockReleaseLockboxTokenPool_PendingRelease>(mapToDict(self.pendingReleases, c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingRelease>(
                        (s) => loadCellRef<LockReleaseLockboxTokenPool_PendingRelease>(s, LockReleaseLockboxTokenPool_PendingRelease.fromSlice),
                        (v,b) => storeCellRef<LockReleaseLockboxTokenPool_PendingRelease>(v, b, LockReleaseLockboxTokenPool_PendingRelease.store)
                    )), c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingRelease>(
            (s) => loadCellRef<LockReleaseLockboxTokenPool_PendingRelease>(s, LockReleaseLockboxTokenPool_PendingRelease.fromSlice),
            (v,b) => storeCellRef<LockReleaseLockboxTokenPool_PendingRelease>(v, b, LockReleaseLockboxTokenPool_PendingRelease.store)
        ));
    },
    storeShallow(self: Storage_Shallow, b: c.Builder): void {
        b.storeRef(self.poolData);
        b.storeAddress(self.lockbox);
        b.storeDict<uint64, LockReleaseLockboxTokenPool_PendingLock>(mapToDict(self.pendingLocks, c.Dictionary.Keys.BigUint(64), createDictionaryValue<LockReleaseLockboxTokenPool_PendingLock>(
                                (s) => loadCellRef<LockReleaseLockboxTokenPool_PendingLock>(s, LockReleaseLockboxTokenPool_PendingLock.fromSlice),
                                (v,b) => storeCellRef<LockReleaseLockboxTokenPool_PendingLock>(v, b, LockReleaseLockboxTokenPool_PendingLock.store)
...
export class LockReleaseLockboxTokenPool implements c.Contract {
    static CodeCell = c.Cell.fromBase64('');
