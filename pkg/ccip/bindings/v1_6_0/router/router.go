// Package router is a FROZEN snapshot of the Router bindings as they were at the
// contracts/1.6.2 release tag, BEFORE the Router_RouteMessage and
// Router_CCIPReceiveConfirm messages gained their `queryId: uint64` field
// ([NONEVM-5740], which landed after the 1.6.2 tag).
//
// DO NOT EDIT BY HAND. This package exists so off-chain tooling can still encode and
// decode messages aimed at a Router deployed with the 1.6.2 interface. The live
// interface lives in pkg/ccip/bindings/router.
//
...
// RouteMessage is the 1.6.2 shape: it does NOT carry a QueryID.
...
// CCIPReceiveConfirm is the 1.6.2 shape: it does NOT carry a QueryID.
