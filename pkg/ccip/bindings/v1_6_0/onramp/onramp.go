// Package onramp is a FROZEN snapshot of the OnRamp bindings as they were at the
// contracts/1.6.2 release tag, BEFORE commit c6655369 ("refactor: inline subcontract code
// dependencies instead of store them") removed the OnRamp_UpdateSendExecutor message and
// restructured OnRamp storage.
//
// DO NOT EDIT BY HAND. This package exists so off-chain tooling can still encode and decode
// messages aimed at an OnRamp deployed with the pre-c6655369 interface — most importantly
// OnRamp_UpdateSendExecutor (0x82901c45), which has no equivalent in the current bindings.
// The live interface lives in pkg/ccip/bindings/onramp.
//
// See chainlink-ton/cciplib/ccip/bindings/README.md for the versioning design.
package onramp
