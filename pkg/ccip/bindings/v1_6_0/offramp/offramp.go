// Package offramp is a FROZEN snapshot of the OffRamp bindings as they were at the
// contracts/1.6.2 release tag, BEFORE commit c6655369 ("refactor: inline subcontract code
// dependencies instead of store them") changed the OffRamp message and storage layouts.
//
// DO NOT EDIT BY HAND. This package exists so off-chain tooling can still encode and decode
// messages aimed at an OffRamp deployed with the pre-c6655369 interface. The live interface
// lives in pkg/ccip/bindings/offramp.
//
...
import (
	...
	ccipcommon "github.com/smartcontractkit/chainlink-ton/cciplib/ccip/bindings/common"
