...
type SetDynamicConfig struct {
	_ tlb.Magic `tlb:"#10000003" json:"-"` //nolint:revive // Ignore opcode tag
	DynamicConfig
}
...
type UpdateDestChainConfigs struct {
	_       tlb.Magic                               `tlb:"#10000004" json:"-"` //nolint:revive // Ignore opcode tag
...
type Send struct {
	_        tlb.Magic  `tlb:"#10000002" json:"-"` //nolint:revive // Ignore opcode tag
