...
type Init struct {
	...
	Proposers  common.SnakeData[common.WrappedAddress] `tlb:"^"`
	Executors  common.SnakeData[common.WrappedAddress] `tlb:"^"`
	Cancellers common.SnakeData[common.WrappedAddress] `tlb:"^"`
	Bypassers  common.SnakeData[common.WrappedAddress] `tlb:"^"`
