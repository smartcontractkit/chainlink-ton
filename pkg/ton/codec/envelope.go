...
type MessageMeta struct {
	Contract tvm.FullyQualifiedType
	Opcode   uint64
...
func NewMessageMetaFromValue(contract tvm.FullyQualifiedType, v any) (MessageMeta, error) {
...
func NewMessageMeta(contract tvm.FullyQualifiedType, typ reflect.Type) (MessageMeta, error) {
...
type messageJSON struct {
	Contract tvm.FullyQualifiedType `json:"contract"`
...
func WrapMessage[T any](contract tvm.FullyQualifiedType, val T) (*MessageEnvelope[T], error) {
...
func MustWrapMessage[T any](contract tvm.FullyQualifiedType, val T) *MessageEnvelope[T] {
