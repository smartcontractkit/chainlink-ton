...
type DebuggerEnvironment struct {
	...
	contracts         map[tvm.FullyQualifiedType]lib.ContractDecoder
...
func defaultDecoders() map[tvm.FullyQualifiedType]lib.ContractDecoder {
	...
	t := make(map[tvm.FullyQualifiedType]lib.ContractDecoder)
...
func registerDecoder(t map[tvm.FullyQualifiedType]lib.ContractDecoder, decoder lib.ContractDecoder) {
