...
// Deploy deploys a contract to the blockchain. It takes a compiledContract
...
func Deploy(codeCell *cell.Cell, client *trace_tracking.SignedAPIClient, initData *cell.Cell, amount tlb.Coins) (*Contract, error) {
