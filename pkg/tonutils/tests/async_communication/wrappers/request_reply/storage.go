...
var STORAGE_CONTRACT_PATH = test_utils.GetBuildDir("examples/async-communication/request-reply/storage/storage_Storage.pkg")
...
func (s Storage) SendGetPriceFrom(priceRegistry *address.Address, key uint8) (queryID uint64, msgReceived *tonutils.ReceivedMessage, err error) {
	queryID = rand.Uint64()
