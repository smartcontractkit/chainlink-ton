...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20251023223359-55e3159deda8
	github.com/smartcontractkit/chainlink-ccip/deployment v0.0.0-20251023223359-55e3159deda8
