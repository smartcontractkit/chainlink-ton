		...
		if bigInt, ok := selector.(*big.Int); ok {
			...
			destConfig := DestChainConfig{
				Config: FeeQuoterDestChainConfig{
					...
					DestGasPerPayloadByteBase:         cfg.FeeQuoterDestChainConfig.DestGasPerPayloadByteBase,
					DestGasPerPayloadByteHigh:         cfg.FeeQuoterDestChainConfig.DestGasPerPayloadByteHigh,
					DestGasPerPayloadByteThreshold:    cfg.FeeQuoterDestChainConfig.DestGasPerPayloadByteThreshold,
					...
					ChainFamilySelector:               cfg.FeeQuoterDestChainConfig.ChainFamilySelector,
