	...
	return []feequoter.UpdateDestChainConfig{
		{
			...
			DestChainConfig: feequoter.DestChainConfig{
				...
				MaxNumberOfTokensPerMsg:           input.Dest.FeeQuoterDestChainConfig.V1Params.MaxNumberOfTokensPerMsg,
				...
				DestGasPerPayloadByteHigh:         input.Dest.FeeQuoterDestChainConfig.V1Params.DestGasPerPayloadByteHigh,
				DestGasPerPayloadByteThreshold:    input.Dest.FeeQuoterDestChainConfig.V1Params.DestGasPerPayloadByteThreshold,
				DestDataAvailabilityOverheadGas:   input.Dest.FeeQuoterDestChainConfig.V1Params.DestDataAvailabilityOverheadGas,
				DestGasPerDataAvailabilityByte:    input.Dest.FeeQuoterDestChainConfig.V1Params.DestGasPerDataAvailabilityByte,
				DestDataAvailabilityMultiplierBps: input.Dest.FeeQuoterDestChainConfig.V1Params.DestDataAvailabilityMultiplierBps,
				...
				GasMultiplierWeiPerEth:            input.Dest.FeeQuoterDestChainConfig.V1Params.GasMultiplierWeiPerEth,
				GasPriceStalenessThreshold:        input.Dest.FeeQuoterDestChainConfig.V1Params.GasPriceStalenessThreshold,
				NetworkFeeUsdCents:                uint32(input.Dest.FeeQuoterDestChainConfig.NetworkFeeUSDCents),
			},
		},
	}
}
