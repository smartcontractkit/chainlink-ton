...
import (
	...
	ccipcodec "github.com/smartcontractkit/chainlink-ton/cciplib/ccip/codec"
...
func (a *TonLaneAdapter) GetFeeQuoterDestChainConfig() lanes.FeeQuoterDestChainConfig {
	return lanes.FeeQuoterDestChainConfig{
		...
		// ton("0.05") for the jetton transfer plus OffRamp_ReleaseOrMint.cost() ton("0.02").
		// 100_000_000 (0.1 TON) comfortably covers all costs in the release flow.
