...
require (
	...
	github.com/smartcontractkit/chainlink-deployments-framework v0.77.0
...
require (
	...
	github.com/smartcontractkit/chainlink-ccip v0.1.1-solana.0.20260128184612-1d15179bf4ce // indirect
