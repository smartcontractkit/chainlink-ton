...
require (
	...
	github.com/smartcontractkit/chainlink-ccip/chains/evm v0.0.0-20260608180601-efa81bfdfda9 // indirect
	...
	github.com/smartcontractkit/chainlink-ton/cciplib v0.1.1-0.20260902151510-9faa280a8e1a // indirect
